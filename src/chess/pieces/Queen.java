...
public class Queen extends ChessPiece {
	...
	public boolean[][] possibleMoves() {
		boolean[][] mat = new boolean[getBoard().getRows()][getBoard().getColumns()]; // matriz de booleanos na mesma
		...
		// Essa foi a lógica para marcar como verdadeiro as posicoes baixo + direita da
		// peca
		p.setValues(position.getRow() + 1, position.getColumn() + 1);
		while (getBoard().positionExists(p) && !getBoard().thereIsAPiece(p)) { // enquanto a posicao p existir e nao
																				// tiver uma peca lá, marcar como
